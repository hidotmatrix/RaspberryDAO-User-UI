...
import raspberrydao_pic_2 from "../../images/Homepage/4.svg";
import raspberrydao_pic_3 from "../../images/Homepage/5.svg";
import raspberrydao_pic_4 from "../../images/Homepage/6.svg";
        ...
        <div>
          ...
          <div className={styles.swappage}>
            ...
            <div className={styles.subheading}>
              Trades on Raspberry DAO are final. Once the transaction is signed, your old NFT will be burned and you will receive an all new generative-art NFT!
            </div>
            <div className={styles.swapbox}>
                  ...
                  <div className={styles.cardinfo}>
                    <div className={styles.card}>
                      ...
                      <div className={styles.aboutcard}>
                        <div className={styles.cardhead}>{Truncate(selected.title)}</div>
              ...
              <div className={styles.middleswapbox}>
                ...
                <div
                  className={swap ? styles.swapbuttonopen : styles.swapbutton}
                >
              ...
              <div className={styles.rightswapbox}>
                ...
                <div className={styles.inputNFT}>
                  <img src={GodwokenImg} alt="Ethereum" className={styles.bitcoinimg}></img>
                  <input
                    name="tonft"
