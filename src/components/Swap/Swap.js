...
function Swap() {
    ...
    return (
        <div className={theme === "light" ? styles.light : styles.dark}>{isLoading?<LoadingSpinner isApprovaltx={isApprovaltx} isSwaptx={isSwaptx}/>:<div>
        ...
        <div className={styles.swappage}>
            ...
            <div className={styles.swapbox}>
                ...
                <div className={swap ? styles.swapbuttonopen : styles.swapbutton}>
                    {swapWrite.write && isApproved ?<button className={styles.buttonswap} disabled={!swapWrite.write} onClick={() => swapWrite.write?.()}>Swap</button>:""}
